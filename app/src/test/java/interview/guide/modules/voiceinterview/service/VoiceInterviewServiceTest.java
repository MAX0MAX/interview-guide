...
@Disabled(
    "Pending rewrite: createSession 现依赖 LlmProviderRegistry.getModuleDefaultProvider（Voice 模块默认 "
        + "Provider 能力引入后），而本测试的 setUp 未向 VoiceInterviewService 注入 LlmProviderRegistry "
